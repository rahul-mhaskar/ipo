...
const SHEET_URL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vRlsMurbsXT2UBQ2ADbyoiQtLUTznQU4vNzw3nS02_StSrFV9pkrnXOrNAjV_Yj-Byc_zw72z_rM0tQ/pub?output=csv"; // Replace with actual CSV URL
  ...
  return (
    ...
    >
          ...
          <Card key={i} className="shadow hover:shadow-lg transition">
            ...
            <CardContent className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm px-2 py-0.5 bg-blue-100 text-blue-600 rounded-full">
                  {ipo.Type}
                </span>
              </div>
              ...
              <div className="text-sm">
                📦 Lot: {ipo.Lot} | Size: {ipo["IPO Size"]}
              </div>
              <div className="text-sm">
                📅 {ipo.Open} - {ipo.Close}
              </div>
              <div className="text-sm">
                🗓️ BoA: {ipo["BoA Dt"]} | 📜 Listing: {ipo.Listing}
              </div>
              {ipo.AllotmentLink1 && (
                <a
      ...
      <footer className="p-4 text-center text-sm text-gray-500 dark:text-gray-400">
        IPO data auto-updated from Google Sheets. Not financial advice. | ©
        2025
      </footer>
    </div>
  );
