...
const GOOGLE_SHEET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRlsMurbsXT2UBQ2ADbyoiQtLUTznQU4vNzw3nS02_StSrFV9pkrnXOrNAjV_Yj-Byc_zw72z_rM0tQ/pub?output=csv"; // Replace with your actual published CSV link
      ...
      <footer className="fixed bottom-0 left-0 w-full bg-white border-t shadow z-50">
        <div className="max-w-7xl mx-auto px-4 py-3">
          ...
          <div className="flex flex-wrap justify-center gap-4 overflow-x-auto pb-2">
            ...
            >
              <img
                src="https://play-lh.googleusercontent.com/angleone-logo"
                alt="Angel One"
                className="h-8 mb-1"
              />
